...
togglePlayer.addEventListener("click", function() {
    ...
    if(isHidden){
        ...
        togglePlayer.innerHTML = '<img class="w-[98%]" src="E:/html/emLinh/icon/close.svg">';
        trackInfo.style.transitionDelay = "0.4s";
        trackNav.style.transitionDelay = "0.4s";
    } else {
        musicPlayer.classList.add("hide");
        togglePlayer.innerHTML = '<img class="w-full" src="E:/html/emLinh/icon/plus.svg">';
...
function playTrack(){
    currentTrack.play();
    isPlaying = true;
    playPauseBtn.innerHTML = '<img class="w-8" src="E:/html/emLinh/icon/pause.svg">';
...
function pauseTrack(){
    currentTrack.pause();
    isPlaying = false;
    playPauseBtn.innerHTML = '<img class="w-8" src="E:/html/emLinh/icon/play.svg">';
